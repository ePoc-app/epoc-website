    ...
    >
        <div class="container flex flex-col gap-2">
                        ...
                        <ul class="flex flex-col gap-2">
                            <li v-for="(link, i) in item.links" :key="i">
                                <NuxtLink
                                    ...
                                    class="text-sm hover:text-primary transition-colors flex items-center justify-center lg:justify-start"
                                >
            ...
            <div class="flex flex-col items-center justify-between gap-2 md:h-24 md:flex-row">
                ...
                <span class="flex-1" />
                <NuxtLink v-for="(link, i) in footer.links" :key="i" :to="localePath(link?.to)" :target="link?.target">
                    <UiButton
                        variant="ghost"
